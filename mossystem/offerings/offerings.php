...
<body>
    ...
    <div class="popup">
        ...
        <div class="container">
            ...
            <form action="offerconnect.php" method="POST">
                ...
                <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <select name="offprogram" id="offprogram">
                            <option>--Select One--</option>
                            <option name="Empowerment Service" label="Empowerment Service" value="Empowerment Service">
                                Empowerment Service</option>
                            <option name="Armour Service" label="Armour Service" value="Armour Service">Armour Service
                            </option>
                            <option name="Missiles Service" label="Missiles Service" value="Missiles Service">Missiles
                                Service</option>
                        </select>
                    </div>
                    <div class="input-box">
    ...
    <a href="offerprint.php"><button id="show-login" name="show-login">Print</button></a>
    ...
    <!--<div class="break">
        ...
        <div class="containero">
            <h2 class="heading center">OVERCOMERS</h2>
            <div class="table-responsive">
                <table class="contentable" id="celltable">
                    ...
                    <tbody>
                        <?php// require 'celloffering.display.php' ?>
                    </tbody>
                </table>
            </div>
        </div>
