...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="proconnect.php" method="POST" enctype="multipart/form-data">
                 ...
                 <div class="input-box">
                     ...
                     <div class="input-box">
                         ...
                         <input type="file" name="imagefile" id="imagefile" accept=".JPG, .jpg, .jpeg, .png, .docx, .pdf. .xlsx">
                     </div>
                 </div>
                      <div class="button">
     ...
     <a href="proprint.php"><button id="show-login" name="show-login">Print</button></a><br>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'procuredisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>
