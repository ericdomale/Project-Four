...
$conn = mysqli_connect("127.0.0.1:3307", "root", "", "mossystem");
 ...
 $query = "SELECT * FROM indietithes WHERE id='$id'";
...
<header>
            ...
            <?php while ($row = mysqli_fetch_array($update)) { ?>
                <div class="user-details">
                    <div class="input-box">
                        ...
                        <input type="text" id="memberno" name="memberno" value="<?php echo $row['memberno'];?>" required>
                    </div>
                    <div class="input-box">
    ...
    <?php 
                    if (isset($_POST['edited']))
                    {
                        ...
                        $conn = mysqli_connect("127.0.0.1:3307", "root", "", "mossystem"); 
                        $query = "UPDATE `indietithes` SET memberno='$_POST[memberno]',fullname='$_POST[fullname]',contact='$_POST[contact]',titdate='$_POST[titdate]',titmonth='$_POST[titmonth]',titamount='$_POST[titamount]' WHERE id='$id'";
