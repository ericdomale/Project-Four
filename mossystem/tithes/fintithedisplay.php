...
/*if(!$_SESSION['username'])
{
 ...
 {?>
    <tr>
        ...
        <td><a href="fintithedit.php?titid=<?php echo $row['titid'];?>" class="edit" id="edit">EDIT</a></td>
        <td><a href="fintithedelete.php?titid=<?php echo $row['titid']; ?>" class="delete">DELETE</a></td>
    </tr>
    <?php 
        }
        echo "</table>";
