...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="fintitheconnect.php" method="POST">
    ...
    <div class="spopup">
        ...
        <div class="container">
            ...
            <form action="findividualconnect.php" method="POST">
                <div class="user-details">
                    <div class="input-box">
    ...
    <div class="jpopup">
        ...
        <div class="container">
            ...
            <form action="finjointconnect.php" method="POST">
                <div class="user-details">
                <div class="input-box">
    ...
    <button class="tablink" onclick="openPage('Couples', this, 'white')">CORPORATE</button>
            ...
            <div id="Overall" class="tabcontent">
             <br><a href="finoverallprint.php"><button id="show-login" name="show-login">Print</button></a><br>
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="contable">
                            ...
                            <tbody>
                                <?php require 'fintithedisplay.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <a href="findieprint.php"><button id="show-login" name="show-login">Print</button></a><br>
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="indietable">
                            ...
                            <tbody>
                                <?php require 'findietithedisplay.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <a href="fincorprint.php"><button id="show-login" name="show-login">Print</button></a><br>
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="jointable">
                            ...
                            <tbody>
                                <?php require 'finjointithedisplay.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
