...
<body>
     ...
     <header>
       ...
       <a href="#" class="cta"><button name="logout_btn">PASSION</button></a>
       </form>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="passionconnect.php" method="POST">
     ...
     <a href="passionaccess.print.php"><button  id="show-login" name="show-login">Print</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'passionaccess.display.php' ?>
            </tbody>
     </table>
        </div>
    </div>
