...
<body>
    ...
    <div class="popup">
        ...
        <div class="container">
            ...
            <form action="prayconnect.php" method="POST">
                ...
                <div class="user-details">
                    ...
                    <div class="input-box">
                        ...
                        <select id="praykind" name="praykind" required>
                            ...
                            <option name="Building Projects" label="Building Projects" value="Building Projects">
                            </option>
                    ...
                    <div class="input-box">
                        ...
                        <input type="date" placeholder="Enter Scheduled Date" id="datescheduled" name="datescheduled"
                            required>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" placeholder="Enter Contact of Person" name="praycontact" id="praycontact"
                            required>
                    </div>
                </div>
                <div class="button">
    ...
    <br><a href="prayprint.php"><button id="show-login" name="show-login">Print</button></a><br>
