...
<body>
     ...
     <header>
       ...
       <h2 class="heading">BREAD OF LIFE</h2>
       <nav>
           <ul class="nav_links">
       ...
       <a href="#" class="cta"><button name="logout_btn">BREAD OF LIFE</button></a>
       </form>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="breadaccess.connect.php" method="POST">
     ...
     <a href="breadaccess.print.php"><button  id="show-login" name="show-login">Print</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'breadaccess.display.php' ?>
            </tbody>
     </table>
        </div>
    </div>
