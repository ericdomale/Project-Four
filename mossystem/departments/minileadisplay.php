...
/*if(!$_SESSION['username'])
{
 ...
 {?>
    <tr>
        ...
        <td><a href="minileadedit.php?erlid=<?php echo $row['erlid'];?>" class="edit" id="edit">EDIT</a></td>
        <td><a href="minileaddelete.php?erlid=<?php echo $row['erlid']; ?>" class="delete">DELETE</a></td>
    </tr>
    <?php 
        }
        echo "</table>";
