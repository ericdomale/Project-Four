...
<body>
    ...
    <div class="popup">
        ...
        <div class="container">
            ...
            <form action="pashepherds.connect.php" method="POST">
    ...
    <div class="spopup">
        ...
        <div class="container">
            ...
            <form action="shepherdlect.php" method="POST">
                <div class="user-details">
                    <div class="input-box">
                ...
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="contable">
                            ...
                            <tbody>
                                <?php require 'pashepherds.display.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="indietable">
                            ...
                            <tbody>
                                <?php require 'pashepherds.lecturers.display.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
