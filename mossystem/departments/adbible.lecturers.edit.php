...
$query = "SELECT * FROM biblelecturers WHERE ltid ='$ltid'";
...
<body>
    ...
    <?php 
                    if (isset($_POST['edited']))
                    {
                        ...
                        $conn = mysqli_connect("127.0.0.1:3307", "root", "", "mossystem"); 
                        $query = "UPDATE `biblelecturers` SET ltid='$_POST[ltid]',fullname='$_POST[fullname]',appdate='$_POST[appdate]',school='$_POST[school]',qualify='$_POST[qualify]',trainings='$_POST[trainings]',lectstatus='$_POST[lectstatus]' WHERE ltid='$_POST[ltid]'";
                        $queryrun = mysqli_query($conn,$query);

                         if ($queryrun)
                         {
                             $_SESSION['success'] ="Details Updated";
                             header('location: adbible.php');
                         }else
                         {
                        ...
                        echo "<script>window.location.href='adbible.php'</script>";
