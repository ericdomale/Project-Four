...
<body>
    ...
    <div class="popup">
        ...
        <div class="container">
            ...
            <form action="adbible.connect.php" method="POST">
    ...
    <div class="spopup">
        ...
        <div class="container">
            ...
            <form action="adbible.lecturer.connect.php" method="POST">
                <div class="user-details">
                    <div class="input-box">
                ...
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="contable">
                            ...
                            <tbody>
                                <?php require 'adbible.students.display.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="indietable">
                            ...
                            <tbody>
                                <?php require 'adbible.lecturers.display.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
