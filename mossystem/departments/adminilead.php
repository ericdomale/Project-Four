...
<body>
    ...
    <div class="popup">
        ...
        <div class="container">
            ...
            <form action="adminileadcon.php" method="POST">
    ...
    <div class="spopup">
        ...
        <div class="container">
            ...
            <form action="adminileadlect.php" method="POST">
                <div class="user-details">
                    <div class="input-box">
                ...
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="contable">
                            ...
                            <tbody>
                                <?php require 'adminileadisplay.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="indietable">
                            ...
                            <tbody>
                                <?php require 'admdlecturerdisplay.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
