...
/*if(!$_SESSION['username'])
{
 ...
 {?>
    <tr>
        ...
        <td><a href="shepherds.lecturers.edit.php?ltid=<?php echo $row['ltid'];?>" class="edit" id="edit">EDIT</a></td>
        <td><a href="shepherds.lecturers.delete.php?ltid=<?php echo $row['ltid']; ?>" class="delete">DELETE</a></td>
    </tr>
    <?php 
        }
        echo "</table>";
