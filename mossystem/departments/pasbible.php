...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="nav_links">
                ...
                <li><a href="../schools/paschools.php" class="person"><img src="../icons/Buildings/home-4-line.svg"
                            alt=""></a></li>
    ...
    <div class="popup">
        ...
        <div class="container">
            ...
            <form action="pasbible.students.connect.php" method="POST">
    ...
    <div class="spopup">
        ...
        <div class="container">
            ...
            <form action="pasbible.lecturer.connect.php" method="POST">
                <div class="user-details">
                    <div class="input-box">
    ...
    <button class="tablink" onclick="openPage('Department', this, 'white')" id="active">DEPARTMENT</button>
                ...
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="contable">
                            ...
                            <tbody>
                                <?php require 'pasbible.students.display.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="indietable">
                            ...
                            <tbody>
                                <?php require 'pasbible.lecturers.display.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <div id="Department" class="tabcontent">
                <div class="containero">
                    ...
                    $query = "SELECT id FROM biblestudents";
                    ...
                    ?>
                            ...
                            $query = "SELECT id FROM biblelecturers";
                            $query_run = mysqli_query($conn,$query);
