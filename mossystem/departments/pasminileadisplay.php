...
/*if(!$_SESSION['username'])
{
   ...
   $conn = mysqli_connect("127.0.0.1:3307", "root", "", "mossystem");
       if ($conn->connect_error) {
        ...
        $sql = "SELECT * FROM minilead ORDER BY id DESC";
 ...
 {?>
    <tr>
        ...
        <td><a href="pasminileadedit.php?erlid=<?php echo $row['erlid'];?>" class="edit" id="edit">EDIT</a></td>
        <td><a href="pasminileaddelete.php?erlid=<?php echo $row['erlid']; ?>" class="delete">DELETE</a></td>
    </tr>
    <?php 
        }
        echo "</table>";
