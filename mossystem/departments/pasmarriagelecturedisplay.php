...
/*if(!$_SESSION['username'])
{
 ...
 {?>
    <tr>
        ...
        <td><a href="pasmarriagelecturedit.php?ltid=<?php echo $row['ltid'];?>" class="edit" id="edit">EDIT</a></td>
        <td><a href="pasmarrylectdelete.php?ltid=<?php echo $row['ltid']; ?>" class="delete">DELETE</a></td>
    </tr>
    <?php 
        }
        echo "</table>";
