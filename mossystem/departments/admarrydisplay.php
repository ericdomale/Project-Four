...
/*if(!$_SESSION['username'])
{
 ...
 {?>
    <tr>
        ...
        <td><a href="admarriagedit.php?erlid=<?php echo $row['erlid'];?>" class="edit" id="edit">EDIT</a></td>
        <td><a href="admarriagedelete.php?erlid=<?php echo $row['erlid']; ?>" class="delete">DELETE</a></td>
    </tr>
    <?php 
        }
        echo "</table>";
