...
<body>
    ...
    <div class="popup">
        ...
        <div class="container">
            ...
            <form action="bibleconnect.php" method="POST">
    ...
    <div class="spopup">
        ...
        <div class="container">
            ...
            <form action="biblelecturerconnect.php" method="POST">
                <div class="user-details">
                    <div class="input-box">
                ...
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="indietable">
                            ...
                            <tbody>
                                <?php require 'biblelecturedisplay.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
