...
$query = "SELECT * FROM mdlecturers WHERE ltid='$ltid'";
...
<body>
  ...
  if (isset($_POST['edited']))
 {
    ...
    $conn = mysqli_connect("127.0.0.1:3307", "root", "", "mossystem"); 
    $query = "UPDATE `mdlecturers` SET ltid='$_POST[ltid]',fullname='$_POST[fullname]',appdate='$_POST[appdate]',school='$_POST[school]',qualify='$_POST[qualify]',trainings='$_POST[trainings]',lectstatus='$_POST[lectstatus]' WHERE ltid='$_POST[ltid]'";
