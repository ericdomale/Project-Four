...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="nav_links">
                ...
                <li><a href="../schools/adschools.php" class="person"><img src="../icons/Buildings/home-4-line.svg"
                            alt=""></a></li>
    ...
    <div class="popup">
        ...
        <div class="container">
            ...
            <form action="admarryconnect.php" method="POST">
    ...
    <div class="spopup">
        ...
        <div class="container">
            ...
            <form action="adlectconnect.php" method="POST">
                <div class="user-details">
                    <div class="input-box">
                ...
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="contable">
                            ...
                            <tbody>
                                <?php require 'admarrydisplay.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="indietable">
                            ...
                            <tbody>
                                <?php require 'admarriagelecturedisplay.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
