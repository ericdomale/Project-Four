...
<body>
    ...
    <div class="popup">
        ...
        <div class="container">
            ...
            <form action="adshepherds.connect.php" method="POST">
    ...
    <div class="spopup">
        ...
        <div class="container">
            ...
            <form action="adshepherdlect.php" method="POST">
                <div class="user-details">
                    <div class="input-box">
    ...
    <button class="tablink" onclick="openPage('Department', this, 'white')" id="active">DEPARTMENT</button>
                ...
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="contable">
                            ...
                            <tbody>
                                <?php require 'adshepherds.display.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="containero">
                    ...
                    <div class="table-responsive">
                        <table class="contentable" id="indietable">
                            ...
                            <tbody>
                                <?php require 'adshepherds.lecturers.display.php' ?>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <div id="Department" class="tabcontent">
                <div class="containero">
                    ...
                    $query = "SELECT id FROM shepschool";
                    ...
                    ?>
                            ...
                            $query = "SELECT id FROM shplecturers";
                            $query_run = mysqli_query($conn,$query);
