...
$query = "SELECT * FROM marriage WHERE erlid='$erlid'";
...
<head>
    ...
    <title>School of Marriage</title>
...
<body>
    ...
    <header>
        ...
        <h2 class="heading">SCHOOL OF MARRIAGE</h2>
        <nav>
            <ul class="nav_links">
    ...
    <?php 
                    if (isset($_POST['edited']))
                    {
                        ...
                        $conn = mysqli_connect("127.0.0.1:3307", "root", "", "mossystem"); 
                        $query = "UPDATE `marriage` SET erlid='$_POST[erlid]',fullname='$_POST[fullname]',bdate='$_POST[bdate]',duration='$_POST[duration]',startdate='$_POST[startdate]',enddate='$_POST[enddate]',erlmonth='$_POST[erlmonth]',maddress='$_POST[maddress]',cstatus='$_POST[cstatus]' WHERE erlid='$_POST[erlid]'";
                        $queryrun = mysqli_query($conn,$query);

                         if ($queryrun)
                         {
                             $_SESSION['success'] ="Details Updated";
                             header('location:admarriage.php');
                         }else
                         {
                        ...
                        echo "<script>window.location.href='admarriage.php'</script>";
