...
<body>
     ...
     <header>
       ...
       <h2 class="heading">MORNING STAR</h2>
       <nav>
           <ul class="nav_links">
       ...
       <a href="#" class="cta"><button name="logout_btn">MORNING STAR</button></a>
       </form>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="starconnect.php" method="POST">
     ...
     <a href="staraccess.print.php"><button  id="show-login" name="show-login">Print</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'staraccessdisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>
