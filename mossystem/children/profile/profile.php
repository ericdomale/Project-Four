...
<body>
    ...
    <?php while ($row = mysqli_fetch_array($update)) { ?>
        ...
        <div class="user">
            ...
            <h3 class="name"><?php echo $row['childname'];?></h3>
            <p class="post"><?php echo $row['childno'];?></p>
        </div>
    ...
    <section class="about" id="about">
        ...
        <h1 class="heading"> <span>member</span> profile </h1>

        <div class="row">

            <div class="info">
                <h3 contenteditable="true"> <span> NAME : </span><?php echo $row['childname'];?></h3>
                <h3 contenteditable="true"> <span> d.o.b : </span><?php echo $row['childbirth'];?></h3>
                <h3 contenteditable="true"> <span> GENDER : </span><?php echo $row['gender'];?></h3>
                <h3 contenteditable="true"> <span> FATHER : </span><?php echo $row['childfather'];?></h3>
                <h3 contenteditable="true"> <span> MOTHER : </span><?php echo $row['childmother'];?></h3>
                <h3 contenteditable="true"> <span> SCHOOL : </span><?php echo $row['childschool'];?></h3>
                <h3 contenteditable="true"> <span> ADDRESS : </span><?php echo $row['childaddress'];?></h3>
            ...
            <div class="counter">
                ...
                <div class="box">
                    <span><?php echo $row['agegroup'];?></span>
                    <h3>age group</h3>
                </div>

                
               <!-- <div class="box">
                    <span><?php// echo $row['cell'];?></span>
                    <h3>cell group</h3>
                </div>

                
                <div class="box">
                    <span><?php //echo $row['chgroup'];?></span>
                    <h3>church group</h3>
                </div>


                <div class="box">
                    <span><?php// echo $row['paddress'];?></span>
                    <h3>G.P.S address</h3>
                </div>-->
    ...
    <section class="education" id="education">
        ...
        <h1 class="heading"> member <span>records</span> </h1>
