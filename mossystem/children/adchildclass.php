...
<body>
    ...
    <div class="cbody">
     <div class="container">
            ...
            <div class="box">
                <a href="../classes/admin.babies.php">
                <div class="imgBx">
            ...
            <div class="box">
                <a href="../classes/admin.diamonds.php">
                <div class="imgBx">
                    <img src="../icons/User/contacts-fill.svg" alt="">
                </div>
                <div class="content">
        ...
        <div class="box">
            <a href="../classes/admin.emeralds.php">
            <div class="imgBx">
                <img src="../icons/User/contacts-fill.svg" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
                <a href="../classes/admin.jasper.php">
                <div class="imgBx">
                    <img src="../icons/User/contacts-fill.svg" alt="">
                </div>
                <div class="content">
            ...
            <div class="box">
                <a href="../classes/admin.sapphire.php">
                <div class="imgBx">
                    <img src="../icons/User/contacts-fill.svg" alt="">
                </div>
                <div class="content">
            ...
            <div class="box">
                <a href="../classes/admin.disciples.php">
                <div class="imgBx">
                    <img src="../icons/User/contacts-fill.svg" alt="">
                </div>
                <div class="content">
