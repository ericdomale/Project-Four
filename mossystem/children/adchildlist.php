...
<body>
     ...
     <header>
       ...
       <nav>
           <ul class="nav_links">
               ...
               <li><a href="../children/adchildren.php" class="person"><img src="../icons/Buildings/home-4-line.svg" alt=""></a></li>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="adchildconnect.php" method="POST">
     ...
     <a href="adchildprint.php"><button id="show-login" name="show-login">Print</button></a><br>
