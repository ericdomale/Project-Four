...
/*if(!$_SESSION['username'])
{
 ...
 {?>
    <tr>
        ...
        <td><a href="adchildedit.php?childno=<?php echo $row['childno']; ?>" class="edit">EDIT</a></td>
        <td><a href="profile/profile.php?childno=<?php echo $row['childno']; ?>" class="view">VIEW</a></td>
        <td><a href="adchildelete.php?childno=<?php echo $row['childno']; ?>" class="delete">DELETE</a></td>
    </tr>
    <?php 
        }
        echo "</table>";
