...
if ($connection->connect_error){
    ...
    $query = "INSERT into childlist (childname, childbirth, agegroup, gender, childfather, childmother, childaddress, childschool, childclass, childteacher)
    values('$childname', '$childbirth', '$agegroup', '$gender', '$childfather', '$childmother', '$childaddress', '$childschool', '$childclass', '$childteacher')";
