...
<head>
    ...
    <link rel="stylesheet" href="childteacher.css">
...
<body>
    ...
    <header>
        ...
        <a href="#"><button id="show-login" name="show-login">Add Teacher</button></a>
    ...
    <div class="popup">
        ...
        <div class="container">
            ...
            <form action="adteachconnect.php" method="POST">
                    ...
                    <div class="input-box">
                        ...
                        <div class="input-box">
                            ...
                            <select name="agegroup" id="agegroup" required>
                                ...
                                <option label="13-21yrs" value="13-21yrs" name="teen"></option>
                                <option label="22-above" value="22-above" name="adult"></option>
                            </select>
                        </div>
                        <div class="input-box">
    ...
    <a href="adteacherprint.php"><button id="show-login" name="show-login">Print</button></a><br>
