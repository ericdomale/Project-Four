...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="advisconnect.php" method="POST">
     ...
     <a href="advisitorprint.php"><button  id="show-login" name="show-login">Print</button></a><br>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'advisitordisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>
