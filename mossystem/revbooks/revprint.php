...
<head>
    ...
    <title>Pastor's Books Report</title>
...
<body>
     ...
     <header>
       ...
       <h2 class="heading2">PASTOR'S BOOKS</h2>
       <nav>
           <ul class="nav_links">
               <!--<li><a href="#">Welcome, <?php /*echo $_SESSION['username'];*/?></a></li>-->
               <li><a href="../revbooks/revbooks.php" class="person"><img src="../icons/Buildings/home-4-line.svg" alt=""></a></li>
     ...
     <a href="revbooks.php"><button  id="show-login" name="show-login">Back</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'revbooksprintdisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>
