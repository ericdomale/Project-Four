...
<body>
    ...
    <div class="popup">
        ...
        <div class="container">
            ...
            <form action="memberconnect2.php" method="POST">
    ...
    <!--<div class="popip center">
     ...
     <a href="admemberprint.php"><button id="show-login" name="show-login">Print</button></a><br>
    <div class="containero">
        <div class="table-responsive">
            <table class="contentable table table-bordered table-hover" id="contable">
                ...
                <tbody>
                    <?php require 'admemberdisplay.php' ?>
                </tbody>
            </table>
        </div>
    </div>
