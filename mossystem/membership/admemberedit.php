...
<body>
    ...
    <?php 
                    if (isset($_POST['edited']))
                    {
                        ...
                        $conn = mysqli_connect("127.0.0.1:3307", "root", "", "mossystem"); 
                        $query = "UPDATE `membership` SET memberno='$_POST[memberno]',fullname='$_POST[fullname]',memdate='$_POST[memdate]',gender='$_POST[gender]',status='$_POST[status]',gender='$_POST[gender]',email='$_POST[email]',contact='$_POST[contact]',maddress='$_POST[maddress]',maddress='$_POST[maddress]',paddress='$_POST[paddress]',work='$_POST[work]',chgroup='$_POST[chgroup]',cell='$_POST[cell]',since='$_POST[since]' WHERE memberno='$_POST[memberno]'";
                        ...
                        echo "<script>window.location.href='admembership.php'</script>";
