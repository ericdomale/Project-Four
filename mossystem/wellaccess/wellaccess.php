...
<head>
    ...
    <link rel="stylesheet" href="wellaccess.css">
...
<body>
     ...
     <header>
       ...
       <h2 class="heading">WELLSPRING</h2>
       <nav>
           <ul class="nav_links">
       ...
       <a href="#" class="cta"><button name="logout_btn">WELLSPRING</button></a>
       </form>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="wellconnect.php" method="POST">
     ...
     <a href="wellaccess.print.php"><button  id="show-login" name="show-login">Print</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'wellaccess.display.php' ?>
            </tbody>
     </table>
        </div>
    </div>
...
<script src="wellaccess.js"></script>
