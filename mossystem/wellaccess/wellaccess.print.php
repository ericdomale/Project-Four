...
<body>
     ...
     <header>
       ...
       <h2 class="heading3">WELLSPRING</h2>
       <nav>
           <ul class="nav_links">
     ...
     <a href="wellaccess.php"><button  id="show-login" name="show-login">Back</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php //require 'wellspring.display.php' ?>
            </tbody>
     </table>
        </div>
    </div>
...
$('#contable').DataTable({
 ...
 "serverSide" : true,
 "ajax" : {
      url:"../cellentry/wellspringfetch.php",
      type:"POST"
     },
 dom: 'lBfrtip',
 buttons: [
