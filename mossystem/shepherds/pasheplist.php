...
<body>
    ...
    <header>
        ...
        <h2 class="heading">SHEPHERD LIST</h2>
        <nav>
            <ul class="nav_links">
    ...
    <div class="popup">
        ...
        <div class="container">
            ...
            <form action="pasheplistconnect.php" method="POST">
                <div class="user-details">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" id="location" name="location" placeholder="Enter Location of Cell">
                    </div>
                </div>
                <div class="button">
    ...
    <a href="pasheprint.php"><button  id="show-login" name="show-login">Print</button></a>
    <div class="containero">
        <div class="table-responsive">
            <table class="contentable" id="contable">
                ...
                <tbody>
                    <?php require 'pasheplistdisplay.php' ?>
                </tbody>
            </table>
        </div>
    </div>
