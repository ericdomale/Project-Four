...
<body>
     ...
     <header>
       ...
       <a href="#" class="cta"><button name="logout_btn">BREAKTHROUGH</button></a>
       </form>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="breakconnect.php" method="POST">
     ...
     <a href="breakaccess.print.php"><button  id="show-login" name="show-login">Print</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'breakaccessdisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>
