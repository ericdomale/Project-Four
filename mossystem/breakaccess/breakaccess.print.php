...
<body>
     ...
     <header>
       ...
       <h2 class="heading2">BREAKTHROUGH</h2>
       <nav>
           <ul class="nav_links">
     ...
     <a href="breakaccess.php"><button  id="show-login" name="show-login">Back</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php //require 'break.print.display.php' ?>
            </tbody>
     </table>
        </div>
    </div>
