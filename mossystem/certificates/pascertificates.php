...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="pascertconnect.php" method="POST">
     ...
     <br><a href="pascertiprint.php"><button  id="show-login" name="show-login">Print</button></a><br>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'pascertdisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>
