...
/*if(!$_SESSION['username'])
{
 ...
 {?>
    <tr>
        ...
        <td><a href="event.edit.php?eventid=<?php echo $row['eventid']; ?>" class="edit">EDIT</a></td>
        <td><a href="eventdelete.php?eventid=<?php echo $row['eventid']; ?>" class="delete">DELETE</a></td>
    </tr>
    <?php 
        }
        echo "</table>";
