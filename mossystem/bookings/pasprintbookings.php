...
<body>
     ...
     <br><a href="pasbookings.php"><button  id="show-login" name="show-login">Back</button></a><br>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php// require 'printbookingsdisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>
