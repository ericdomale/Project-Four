...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="attendconnect2.php" method="POST">
     ...
     <a href="admattendprint.php"><button id="show-login" name="show-login">Print</button></a><br>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'admattendisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>   
