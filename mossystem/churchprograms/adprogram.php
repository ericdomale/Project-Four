...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="adprogconnect.php" method="POST">
     ...
     <br><a href="adprintprogram.php"><button  id="show-login" name="show-login">Print</button></a><br>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'adchprogramdisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>
