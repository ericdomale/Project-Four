...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="pasprogconnect.php" method="POST">
     ...
     <br><a href="pasprintprogram.php"><button  id="show-login" name="show-login">Print</button></a><br>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'paschprogramdisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>
