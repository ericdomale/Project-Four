...
/*if(!$_SESSION['username'])
{
 ...
 {?>
    <tr>
        ...
        <td><a href="adchprogedit.php?chprogid=<?php echo $row['chprogid']; ?>" class="edit">EDIT</a></td>
        <td><a href="adchprogdelete.php?chprogid=<?php echo $row['chprogid']; ?>" class="delete">DELETE</a></td>
    </tr>
    <?php 
        }
        echo "</table>";
