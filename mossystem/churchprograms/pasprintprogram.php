...
<head>
    ...
    <title>Church Programs Report</title>
...
<body>
     ...
     <header>
       ...
       <h2 class="heading2">CHURCH PROGRAMS</h2>
       <nav>
           <ul class="nav_links">
     ...
     <br><a href="pasprogram.php"><button  id="show-login" name="show-login">Back</button></a><br>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'printprogramdisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>
