...
/*if(!$_SESSION['username'])
{
 ...
 {?>
    <tr>
        ...
        <td><a href="paschprogedit.php?chprogid=<?php echo $row['chprogid']; ?>" class="edit">EDIT</a></td>
        <td><a href="paschprogdelete.php?chprogid=<?php echo $row['chprogid']; ?>" class="delete">DELETE</a></td>
    </tr>
    <?php 
        }
        echo "</table>";
