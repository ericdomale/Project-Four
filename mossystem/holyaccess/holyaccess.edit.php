...
$query = "SELECT * FROM holyhill WHERE id='$id'";
...
function load_names(){
    $conn = mysqli_connect('127.0.0.1:3307','root','','mossystem');
    $output = '';
    $sql = "SELECT * FROM membership  WHERE cell= 'Holy Hill' ORDER BY memberno";
...
<head>
    ...
    <link rel="stylesheet" href="holyaccess.css">
...
<body>
     ...
     <?php 
                    if (isset($_POST['edited']))
                    {
                        ...
                        $conn = mysqli_connect("127.0.0.1:3307", "root", "", "mossystem"); 
                        $query = "UPDATE `holyhill` SET entrydate='$_POST[entrydate]',connumber='$_POST[connumber]',choristers='$_POST[choristers]',preacher='$_POST[preacher]',message='$_POST[message]',ofamount='$_POST[ofamount]',members='$_POST[members]',connames='$_POST[connames]',attended='$attended' WHERE id='$id'";
                        ...
                        echo "<script>window.location.href='holyaccess.php'</script>";
