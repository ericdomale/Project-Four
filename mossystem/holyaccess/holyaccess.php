...
<body>
     ...
     <header>
       ...
       <a href="#" class="cta"><button name="logout_btn">HOLY HILL</button></a>
       </form>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="holyconnect.php" method="POST">
     ...
     <a href="holyaccess.print.php"><button  id="show-login" name="show-login">Print</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'holyaccess.display.php' ?>
            </tbody>
     </table>
        </div>
    </div>
...
<script src="holyaccess.js"></script>
