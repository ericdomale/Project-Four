...
<body>
    ...
    <?php while ($row = mysqli_fetch_array($update)) { ?>
        ...
        <div class="user">
            ...
            <p class="post"><?php echo $row['memberno'];?></p>
        </div>
    ...
    <section class="about" id="about">
        ...
        <h1 class="heading"> <span><?php echo $row['fullname'];?> </span> Profile </h1>

        <div class="row">

            <div class="info">
                <h3 contenteditable="true"> <span> NAME : </span><?php echo $row['fullname'];?></h3>
                <h3 contenteditable="true"> <span> D.O.B : </span><?php echo $row['memdate'];?></h3>
                ...
                <h3 contenteditable="true"> <span> ADDRESS : </span><?php echo $row['maddress'];?></h3>
    ...
    <section class="education" id="education">
        ...
        <h1 class="heading"> <?php echo $row['fullname'];?> <span>Records</span> </h1>
    ...
    <section class="portfolio" id="portfolio">
        ...
        <h1 class="heading"> <?php echo $row['fullname'];?> <span>Certificates</span> </h1>
