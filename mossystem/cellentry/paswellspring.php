...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="../entryconnection/wellconnect.php" method="POST">
     ...
     <a href="paswellspring.print.php"><button  id="show-login" name="show-login">Print</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'paswellspring.display.php' ?>
            </tbody>
     </table>
        </div>
    </div>
