...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="../entryconnection/goodconnect.php" method="POST">
     ...
     <a href="pasgoodshepherd.print.php"><button  id="show-login" name="show-login">Print</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'pasgoodshepherd.display.php' ?>
            </tbody>
     </table>
        </div>
    </div>
