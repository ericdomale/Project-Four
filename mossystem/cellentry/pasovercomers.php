...
<body>
     ...
     <!--<div class="viewmembers">
        ...
        // $query = "SELECT * FROM overcomersentry  WHERE attended= 'entrydate'";
     ...
     <a href="pasovercomers.print.php"><button  id="show-login" name="show-login">Print</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'pasovercomersdisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>
