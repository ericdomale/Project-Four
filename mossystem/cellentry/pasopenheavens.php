...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="../entryconnection/opheavensconnect.php" method="POST">
     ...
     <a href="pasopenheavens.print.php"><button  id="show-login" name="show-login">Print</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'pasopheavensdisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>
