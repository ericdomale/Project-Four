...
<body>
     ...
     <header>
       ...
       <nav>
           <ul class="nav_links">
               ...
               <li><a href="pasovercomers.php" class="person"><img src="../icons/Buildings/home-4-line.svg" alt=""></a></li>
     ...
     <a href="pasovercomers.php"><button  id="show-login" name="show-login"><-- BACK</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'over.record.view.php' ?>
            </tbody>
     </table>
        </div>
    </div>
