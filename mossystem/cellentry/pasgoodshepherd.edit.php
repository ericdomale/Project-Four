...
$query = "SELECT * FROM goodshepherd WHERE id='$id'";
...
<head>
    ...
    <link rel="stylesheet" href="goodshepherd.css">
...
<body>
     ...
     <?php 
                    if (isset($_POST['edited']))
                    {
                        ...
                        $conn = mysqli_connect("127.0.0.1:3307", "root", "", "mossystem"); 
                        $query = "UPDATE `goodshepherd` SET entrydate='$_POST[entrydate]',connumber='$_POST[connumber]',choristers='$_POST[choristers]',preacher='$_POST[preacher]',message='$_POST[message]',ofamount='$_POST[ofamount]',members='$_POST[members]',connames='$_POST[connames]',attended='$attended' WHERE id='$id'";
                        ...
                        echo "<script>window.location.href='pasgoodshepherd.php'</script>";
...
<script src="goodshepherd.js"></script>
