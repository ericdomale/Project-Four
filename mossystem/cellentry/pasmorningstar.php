...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="../entryconnection/starconnect.php" method="POST">
     ...
     <a href="pastar.print.php"><button  id="show-login" name="show-login">Print</button></a>
