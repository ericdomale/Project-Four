...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="../entryconnection/breadconnect.php" method="POST">
     ...
     <a href="pasbread.print.php"><button  id="show-login" name="show-login">Print</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'pasbread.display.php' ?>
            </tbody>
     </table>
        </div>
    </div>
