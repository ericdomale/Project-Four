...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="../entryconnection/dunamisconnect.php" method="POST">
     ...
     <a href="pasdunamis.print.php"><button  id="show-login" name="show-login">Print</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'pasdunamis.display.php' ?>
            </tbody>
     </table>
        </div>
    </div>
