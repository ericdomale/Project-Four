...
<body>
     ...
     <header>
       ...
       <a href="#" class="cta"><button name="logout_btn">OPEN HEAVENS</button></a>
       </form>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="openconnect.php" method="POST">
     ...
     <a href="openaccess.print.php"><button  id="show-login" name="show-login">Print</button></a>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'openaccessdisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>
