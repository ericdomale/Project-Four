...
/*if(!$_SESSION['username'])
{
 ...
 {?>
    <tr>
        ...
        <td><a href="finexpensedit.php?expid=<?php echo $row['expid']; ?>" class="edit">EDIT</a></td>
        <td><a href="finexpensedelete.php?expid=<?php echo $row['expid']; ?>" class="delete">DELETE</a></td>
    </tr>
    <?php 
        }
        echo "</table>";
