...
$query = "SELECT * FROM overcomersentry WHERE id='$id'";
...
<head>
    ...
    <link rel="stylesheet" href="overaccess.css">
...
<body>
     ...
     <?php 
                    if (isset($_POST['edited']))
                    {
                        ...
                        $conn = mysqli_connect("127.0.0.1:3307", "root", "", "mossystem"); 
                        $query = "UPDATE `overcomersentry` SET entrydate='$_POST[entrydate]',connumber='$_POST[connumber]',choristers='$_POST[choristers]',preacher='$_POST[preacher]',message='$_POST[message]',ofamount='$_POST[ofamount]',members='$_POST[members]',connames='$_POST[connames]',attended='$attended' WHERE id='$id'";
                        ...
                        echo "<script>window.location.href='overaccess.php'</script>";
...
<script src="overaccess.js"></script>
