...
<body>
     ...
     <div class="popup">
         ...
         <div class="container">
             ...
             <form action="adannconnect.php" method="POST">
     ...
     <a href="admannprint.php"><button id="show-login" name="show-login">Print</button></a><br>
     <div class="containero">
        <div class="table-responsive">
          ...
          <thead>
            ...
            <tbody>
               <?php require 'adannouncedisplay.php' ?>
            </tbody>
     </table>
        </div>
    </div>   
