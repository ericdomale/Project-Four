...
if ($connection->connect_error){
    ...
    $query = "INSERT into breadoflife (entrydate, connumber, choristers, preacher, message, ofamount, members, connames, attended)
    ...
    header('location: ../cellentry/breadoflife.php');
