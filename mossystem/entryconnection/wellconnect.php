...
if ($connection->connect_error){
    ...
    $query = "INSERT into wellspring (entrydate, connumber, choristers, preacher, message, ofamount, members, connames, attended)
    ...
    header('location: ../cellentry/wellspring.php');
