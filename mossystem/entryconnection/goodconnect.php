...
if ($connection->connect_error){
    ...
    $query = "INSERT into goodshepherd (entrydate, connumber, choristers, preacher, message, ofamount, members, connames, attended)
    ...
    header('location: ../cellentry/goodshepherd.php');
