...
if ($connection->connect_error){
    ...
    $query = "INSERT into morningstar (entrydate, connumber, choristers, preacher, message, ofamount, members, connames, attended)
    ...
    header('location: ../cellentry/morningstar.php');
