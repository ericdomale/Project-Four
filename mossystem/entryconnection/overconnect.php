...
if ($connection->connect_error){
    ...
    $query = "INSERT into overcomersentry (entrydate, connumber, choristers, preacher, message, ofamount, members, connames, attended)
    ...
    header('location: ../cellentry/overcomers.php');
