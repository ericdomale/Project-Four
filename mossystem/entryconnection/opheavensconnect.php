...
if ($connection->connect_error){
    ...
    $query = "INSERT into opheavens (entrydate, connumber, choristers, preacher, message, ofamount, members, connames, attended)
    ...
    header('location: ../cellentry/openheavens.php');
