...
if ($connection->connect_error){
    ...
    $query = "INSERT into breakthrough (entrydate, connumber, choristers, preacher, message, ofamount, members, connames, attended)
    ...
    header('location: ../cellentry/breakthrough.php');
